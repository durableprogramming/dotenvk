...
# VHS tape file path
TAPE_FILE="$SCRIPT_DIR/quickdemo.tape"

# Output GIF path
OUTPUT_GIF="$SCRIPT_DIR/quickdemo.gif"
...
echo "Recording quick dotenvk demo with VHS..."
echo "Output will be saved to: $OUTPUT_GIF"

# Record the demo
vhs "$TAPE_FILE"

echo "Quick demo recording complete! GIF saved to $OUTPUT_GIF"
